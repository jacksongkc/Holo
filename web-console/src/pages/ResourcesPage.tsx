...
export function ResourcesPage() {
  ...
  const canWrite = hasPermission((user?.role as "admin" | "operator" | "viewer") || "viewer", "resources:write");
    ...
    <section>
      <div className="page-header">
        <div className="inline-actions" style={{ justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <button className="btn btn-primary" type="button" onClick={() => setVtlDialogOpen(true)} disabled={!canWrite}>
            <Plus size={14} />
